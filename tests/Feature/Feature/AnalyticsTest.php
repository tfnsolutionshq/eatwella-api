...
class AnalyticsTest extends TestCase
{
    ...
    public function test_admin_can_view_top_menus()
    {
        ...
        // Order 1: 2 Pizzas
        $order1 = Order::create(['order_number' => 'ORD-1', 'customer_email' => 'a@b.com', 'total_amount' => 40, 'final_amount' => 40, 'status' => 'completed']);
        OrderItem::create(['order_id' => $order1->id, 'menu_id' => $menu1->id, 'quantity' => 2, 'price' => 20, 'subtotal' => 40]);

        // Order 2: 1 Burger
        $order2 = Order::create(['order_number' => 'ORD-2', 'customer_email' => 'a@b.com', 'total_amount' => 10, 'final_amount' => 10, 'status' => 'completed']);
